...
- Buatlah sebuah abstract class bernama Mahasiswa
- Properti Atribut Terenkapsulasi ( protected ): id_mahasiswa, nama_mahasiswa, nim, semester, tarifUktNominal (Nilai properti ini wajib dipetakan secara pas dari kolom tabel database yang telah dibuat tahap 1)
- Metode Abstract (Tanpa isi/Body) wajib mendeklarasikan abstract method hitungTagihanSemester() dan tampilkanSpesifikasiAkademik()